...
{
    RED_CHECK(compare_binary_ipv4("127.0.0.1", "127.0.0.1"));
    RED_CHECK(compare_binary_ipv4("192.0.2.128", "192.0.2.128"));
    RED_CHECK(compare_binary_ipv4("255.6.42.125", "255.6.42.125"));
    RED_CHECK(compare_binary_ipv4("1.2.3.4", "1.2.3.4"));
    RED_CHECK(compare_binary_ipv4("10.20.100.200", "10.20.100.200"));
    RED_CHECK(compare_binary_ipv4("0.0.0.0", "0.0.0.0"));
    RED_CHECK(compare_binary_ipv4("55.66.77.88", "55.66.77.88"));

    RED_CHECK(!compare_binary_ipv4("32.18.99.22", "58.187.5.221"));
    RED_CHECK(!compare_binary_ipv4("0.0.0.0", "0.0.0.1"));
    RED_CHECK(!compare_binary_ipv4("11.22.33.44", "55.66.77.88"));
    RED_CHECK(!compare_binary_ipv4("192.0.2.128", "255.6.42.125"));
    RED_CHECK(!compare_binary_ipv4("abcd", "efgh"));
    RED_CHECK(!compare_binary_ipv4("1.2.3.", "4242"));
    RED_CHECK(!compare_binary_ipv4("", ""));
}

RED_AUTO_TEST_CASE(Test_compare_binary_ipv6)
{
    RED_CHECK(compare_binary_ipv6("2001:abcd::1234",
                                  "2001:abcd::1234"));
    RED_CHECK(compare_binary_ipv6("fe80::",
                                  "fe80::"));
    RED_CHECK(compare_binary_ipv6("::1",
                                  "0000:0000:0000:0000:0000:0000:0000:0001"));
    RED_CHECK(compare_binary_ipv6("2a0d:5d40:888:4176:d999:e759:0962:019f",
                                  "2a0d:5d40:888:4176:d999:e759:962:19f"));
    RED_CHECK(compare_binary_ipv6("2001:0db8:0000:0000:1:ff00:0042:8329",
                                  "2001:0db8::0000:1:ff00:0042:8329"));
    RED_CHECK(compare_binary_ipv6("2001:db8:3c4d:15:0:d234:3eee::",
                                  "2001:db8:3c4d:15:0:d234:3eee:0000"));
    RED_CHECK(compare_binary_ipv6("::ffff:127.0.0.1",
                                  "::ffff:127.0.0.1"));

    RED_CHECK(!compare_binary_ipv6("::ffff:255.255.255.255",
                                   "::ffff:127.0.0.1"));
    RED_CHECK(!compare_binary_ipv6("2001:abcd::1234",
                                   "fe80::"));
    RED_CHECK(!compare_binary_ipv6("2a0d:0356:0888:abcd:d999:957e:0333:012a",
                                   "2001:0db8:0000:0000::ff00:0042:8329"));
    RED_CHECK(!compare_binary_ipv6("::1",
                                   "::"));
    RED_CHECK(!compare_binary_ipv6("abcdefgh",
                                   "abcdefgh"));
    RED_CHECK(!compare_binary_ipv6("1:2:3:4",
                                   "5:6:7:8"));
    RED_CHECK(!compare_binary_ipv6("", ""));
}
...
RED_AUTO_TEST_CASE(ParseIpConntrack_IPv4)
{
    ...
    auto ip_compare = compare_binary_ipv4;
...
RED_AUTO_TEST_CASE(ParseIpConntrack_IPv6)
{
    ...
    auto ip_compare = compare_binary_ipv6;
